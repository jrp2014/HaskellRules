...
extEnv ((s, f):env) = mplus (return (s, f)) (extEnv env)
extEnv [] = mzero
...
nott = minf baseenv (App (Var "not") (Var "t"))

not1 = minf baseenv (App (Var "not") (Var "1"))

ptt = minf baseenv (App (App (Var "plus") (Var "t")) (Var "t"))

sid = minf baseenv (Pair (App (Var "id") (Var "1")) (App (Var "id") (Var "t")))
